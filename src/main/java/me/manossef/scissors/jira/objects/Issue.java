...
public record Issue(String id, String key, Fields fields, String[] errorMessages) {
    ...
    public record Fields(Issuetype issuetype, Project project, Resolution resolution, String created, Priority priority, Status status, String summary, String description, IssueLink[] issuelinks, String customfield_10152, String customfield_10153) {
